...
public class lab1q3 {
    ...
    public static void classificationFinder () {
        ...
        studentClass studentRecord = createStudentRecord();

        System.out.println("\nWelcome " + studentRecord.name + " to OOP");
        System.out.println(comparePercentages(studentRecord.average));

    }

    public static studentClass createStudentRecord() {

        studentClass studentRecord = new studentClass();
        studentRecord.name = stringInputNoNumbers("Whats your name? ");
        studentRecord.average = doubleInputInRange("Whats your average perctentage: ", 0, 100, false, false);
